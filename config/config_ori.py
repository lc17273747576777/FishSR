...
parser.add_argument('--image_size', type=int, default=24, help='the height / width of the hr image to network')
...
parser.add_argument('--scale_factor', type=int, default=1, help='scale factor for super resolution')
