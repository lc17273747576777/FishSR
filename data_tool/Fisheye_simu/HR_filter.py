...
# LR_path = "F:/WJ_project/dataset/realSR/ori/Flickr2K_LR_2D"
HR_path = "F:/WJ_project/dataset/realSR/ori/DIV2K_train_HR"
LR_path = "F:/WJ_project/dataset/realSR/ori/DIV2K_train_LR_2D"
output_path = "F:/WJ_project/dataset/realSR/crop576"
start_num = 0

def crop_coner(img, idx, cropsize=288, border=4):
    h, w, c = img.shape
...
output_LR_path = os.path.join(output_path, 'LR_2D')
...
for dirpath, dirnames, filenames in os.walk(HR_path):
    for filename in filenames:
        ...
        # LR_file = LR_file.replace('Flickr2K_HR', 'Flickr2K_LR_2D')
        LR_file = LR_file.replace('DIV2K_train_HR', 'DIV2K_train_LR_2D')
        ...
        for idx in range(1, 5):
            crop_HR = crop_coner(input_img_HR, cropsize=576, idx=idx, border=4)
            crop_LR = crop_coner(input_img_LR, cropsize=288, idx=idx, border=2)
